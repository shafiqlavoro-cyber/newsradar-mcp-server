...
// I'll make sure there's no conflict with existing code. Let's find "app.post('/sheets/completa'" and add our endpoints right before it.
...
// First remove the ones we just added to be safe
content = content.replace(/\/\/ ═══════════════════════════════════════════════════════\n\/\/  ENDPOINT PER CONTENT HUB[\s\S]*?(?=\/\/ ═══════════════════════════════════════════════════════\n\/\/  ENDPOINT PER GEMINI)/, '');

// Then add them properly
content = content.replace('// ═══════════════════════════════════════════════════════\n//  ENDPOINT PER GEMINI — gestione coda articoli', newEndpoints + '// ═══════════════════════════════════════════════════════\n//  ENDPOINT PER GEMINI — gestione coda articoli');
